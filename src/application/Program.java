        ...
        while (escolha != 7) {
            ...
            switch (escolha) {
                case 1: //cadastro do cliente
                    ...
                    sc.nextLine();
                    //for para percorrer a quantidade de vezes que a pessoa quer cadastras os clientes dentro da lista
                ...
                case 2: //busca de cliente e ou alteração de dados cadastrados
                    ...
                    String name = sc.nextLine();
                    //foreach para percorrer a lista dos usuários e comparar o nome que foi inserido com o da lista.
                    for(User usuario : usuarios){
                        String nameUsuario = usuario.getName();
                        //if do comparador, quando ele compara se for true ele entra dentro do if e printa as informações do cliente.
                        if(name.equals(nameUsuario)){
                            System.out.println("Nome encontrado!");
                            //puxa as informações da lista usuario que foi criada lá em cima, printando ao usuário.
                                ...
                                while (op == 1) {
                                    ...
                                    switch (opalterar) {
                                        case 1:
                                            ...
                                            //puxa a informação, essa informação depende do setATRIBUTO, onde a var dentro dos () vai ser alocada na list.
                                        ...
                                        case 3:
                                            ...
                                            break;
                                        case 4:
                                            //caso o usuário queira sair do menu, o op que é a var do switch contara 1++, comparando com == 1, ele irá sair do switch.
                                            op++;
                                            break;
                                    }
                            }
                ...
                case 3:
                    ...
                    sc.nextLine();
                    //for para percorrer toda a arraylist e cadastrar cada uma em seu determinado lugar na lista.
                ...
                case 4:
                    sc.nextLine();
                    //boolean para fazer a logica da pesquisa, iniciando com falso pois ainda não foi achado
                    ...
                    for(Product produto : products){
                        ...
                        //e compara com a que o user inseriu no nome a ser pesquisado, caso seja entra no if
                        if(nomeProduct.equals(nameProduct)){
                            ...
                            while (opProd == 1){
                                ...
                                System.out.println("Oque você deseja alterar: [1]Nome / [2]Descrição / [3]Valor / [4]Porcentagem de lucro / [5]Quantidade / [6]Sair");
                                int opAltProd = sc.nextInt();
                                switch (opAltProd){
                                    case 1:
                                        //pergunta oque vai ser mudado, nesse caso é o nome, porém a logica é a mesma para o resto
                                        System.out.println("Qual nome você deseja colocar: ");
                                        sc.nextLine();
                                        //a var recebe
                                        String nomeAltProd = sc.nextLine();
                                        //apos receber oque o usuário digitou, ele seta oque sera mudado dentro da arraylist produto,
                ...
                case 5:
                    ...
                    for(User cliente : usuarios){
                        ...
                        //e vai comparar as 2 para saber se ele realmente existe, caso sim, ele entra no if
                    ...
                    if(!searchCli){
                        ...
                        //cadastro de vendas para clientes, o user escolhe a opção e caso sim, cadastra, se não volta ao menu
                        System.out.println("Você deseja cadastrar vendas ao cliente " +selectClient+": [1]Sim / [2]Não");
                        int opCliente = sc.nextInt();
                        //se a opção for igual a 1, entra dentro do while pra no final ele perguntar novamente
                        ...
                        while (opCliente == 1) {
                            ...
                            for (Product produto : products) {
                                ...
                                //compara o nome inserido pelo user com o da arraylist, caso seja igual ele entra no if
                                if (selectProduct.equals(pesquisaProduct)) {
                                    ...
                                    //foreach para percorrer a arraylist dos produtos
                                        ...
                                        //caso a subtração seja maior que 0, ou seja, valor minimo do estoque ele printa o resultado
                                        if (resultado >= 0) {
